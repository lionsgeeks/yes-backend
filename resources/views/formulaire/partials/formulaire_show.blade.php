    ...
    <div class="w-full overflow-x-auto">
        <table class="capitalize w-full md:table block">
            ...
            @foreach ($fields as $question => $field)
                <tr class="{{ $loop->iteration % 2 == 0 ? 'bg-alpha/10' : '' }} md:w-full w-[88vw] block md:table-row mb-4 md:mb-0 rounded-lg md:rounded-none border border-alpha/20 md:border-0 overflow-hidden">
                    <td class="border-alpha p-3 md:table-cell block md:border before:content-[attr(data-title)] before:font-bold before:block md:before:hidden before:mb-1 md:before:mb-0" data-title="{{ $question }}">
                    ...
                    <td class="border-alpha p-3 md:table-cell block md:border font-medium md:font-normal">
                        ...
                        @elseif (in_array($field, [
                            ...
                            @if ($form->$field)
                                <div class="flex gap-2 items-center border border-alpha p-2 rounded justify-start md:justify-center">
